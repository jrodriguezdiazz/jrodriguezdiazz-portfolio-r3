        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex items-center justify-center space-x-6 mb-6 text-gray-600 dark:text-gray-400">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-lg font-semibold">Senior Software Engineer</span>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 text-center border border-blue-200 dark:border-blue-800">
              <div className="text-blue-600 dark:text-blue-400 text-2xl font-bold mb-2">Frontend</div>
            ...
            <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 text-center border border-green-200 dark:border-green-800">
              <div className="text-green-600 dark:text-green-400 text-2xl font-bold mb-2">Backend</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Node.js, PostgreSQL, APIs</div>
            </div>
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-6 text-center border border-purple-200 dark:border-purple-800">
              <div className="text-purple-600 dark:text-purple-400 text-2xl font-bold mb-2">Cloud</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Microservices, DevOps</div>
            </div>
          </div>

          {/* Social Links */}
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="https://github.com/jrodriguezdiazz" target="_blank" className="group">
              <Button
                variant="outline"
                size="lg"
            ...
            <Link href="https://www.linkedin.com/in/jrodriguezdiazz" target="_blank" className="group">
              <Button
                variant="outline"
                size="lg"
            ...
            <Link href="https://x.com/jrodriguezdiazz" target="_blank" className="group">
              <Button
                variant="outline"
                size="lg"
                className="bg-white/80 hover:bg-blue-50 dark:bg-gray-800/80 dark:hover:bg-blue-900/20 border-gray-300 dark:border-gray-600 transition-all duration-200 hover:shadow-lg hover:scale-105"
